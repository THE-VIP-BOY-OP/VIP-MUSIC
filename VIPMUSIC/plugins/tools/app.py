...
def forward_messages(client, message):
    ...
    messages = client.get_chat_history(source_channel, limit=100)  # Adjust limit as needed
    ...
    userbot.send_message(chat_id=source_channel, text="Messages have been forwarded successfully!")
