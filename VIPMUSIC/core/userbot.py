...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("YARANA_TG")
                await self.one.join_chat("DX_INFO")
                await self.one.join_chat("DXallBot")
                await self.one.join_chat("TG_Rules")
                await self.one.join_chat("SOURSE_TG")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("DXallBot")
                await self.two.join_chat("TG_Rules")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("YARANA_TG")
                await self.three.join_chat("DX_INFO")
                await self.three.join_chat("DXallBot")
                await self.three.join_chat("TG_Rules")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("YARANA_TG")
                await self.four.join_chat("DX_INFO")
                await self.four.join_chat("DXallBot")
                await self.four.join_chat("TG_Rules")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("YARANA_TG")
                await self.five.join_chat("DX_INFO")
                await self.five.join_chat("DXallBot")
                await self.five.join_chat("TG_Rules")
            except:
                pass
            assistants.append(5)
            try:
