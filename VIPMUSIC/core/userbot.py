...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Ard_feels")
                await self.one.join_chat("BuDdYieZzz")
                await self.one.join_chat("BuDdYieZzz")
                await self.one.join_chat("Ard_feels")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Ard_feels")
                await self.two.join_chat("BuDdYieZzz")
                await self.two.join_chat("BuDdYieZzz")
                await self.two.join_chat("Ard_feels")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Ard_feels")
                await self.three.join_chat("BuDdYieZzz")
                await self.three.join_chat("BuDdYieZzz")
                await self.three.join_chat("Ard_feels")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Ard_feels")
                await self.four.join_chat("BuDdYieZzz")
                await self.four.join_chat("BuDdYieZzz")
                await self.four.join_chat("Ard_feels")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Ard_feels")
                await self.five.join_chat("BuDdYieZzz")
                await self.five.join_chat("BuDdYieZzz")
                await self.five.join_chat("Ard_feels")
            except:
                pass
