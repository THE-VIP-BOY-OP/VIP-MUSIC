...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"VIPMUSIC/assets/vipmusic.png")
        ...
        font = ImageFont.truetype("VIPMUSIC/assets/font2.ttf", 45)
        ImageFont.truetype("VIPMUSIC/assets/font2.ttf", 70)
        arial = ImageFont.truetype("VIPMUSIC/assets/font2.ttf", 30)
        ImageFont.truetype("VIPMUSIC/assets/font.ttf", 30)
