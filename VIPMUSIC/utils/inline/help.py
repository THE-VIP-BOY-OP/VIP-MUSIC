        ...
        [
            [
                InlineKeyboardButton(
                    text=_["H_B_1"], callback_data="helpcallback hb1"
                ),
                InlineKeyboardButton(
                    text=_["H_B_2"], callback_data="helpcallback hb2"
                ),
                InlineKeyboardButton(
                    text=_["H_B_3"], callback_data="helpcallback hb3"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_["H_B_4"], callback_data="helpcallback hb4"
                ),
                InlineKeyboardButton(
                    text=_["H_B_12"], callback_data="helpcallback hb12"
                ),
                InlineKeyboardButton(
                    text=_["H_B_5"], callback_data="helpcallback hb5"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_["H_B_6"], callback_data="helpcallback hb6"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_["H_B_8"], callback_data="helpcallback hb8"
                ),
                InlineKeyboardButton(
                    text=_["H_B_9"], callback_data="helpcallback hb9"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_["H_B_11"], callback_data="helpcallback hb11"
                )
            ],
            controll_button,
        ]
...
def second_page(_):
    ...
    second_page_menu = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text=_["H_B_7"], callback_data="helpcallback hb7"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_["H_B_21"], callback_data="helpcallback hb21"
                )
            ],
            controll_button,
        ]
