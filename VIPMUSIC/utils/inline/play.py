...
def stream_markup_timerr(_, videoid, chat_id, played, dur):
    ...
    if 10 < umm <= 20:
        bar = "💞ᴄʟɪᴄᴋ ᴛᴏ ɪᴏɪɴ ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs💞"
    elif 20 <= umm < 35:
        bar = "🎄ᴛᴀᴘ ᴛᴏ ᴇɴᴛᴇʀ ᴍᴏʀᴇ ɢʀᴏᴜᴘs ɴᴏᴡ🎄"
    elif 35 <= umm < 50:
        bar = "🎁ᴄʟɪᴄᴋ ᴛᴏ ɢᴇᴛ ᴀᴅᴅᴇᴅ ɪɴ ɴᴇᴡ ᴄʜᴀᴛs🎁"
    elif 50 <= umm < 75:
        bar = "⚜️ᴛᴀᴘ ʜᴇʀᴇ ғᴏʀ ᴍᴏʀᴇ ᴄʜᴀᴛ ɪɴᴠɪᴛᴇs⚜️"
    elif 75 <= umm < 80:
        bar = "🔥ᴄʟɪᴄᴋ ᴛᴏ ᴀᴄᴄᴇss ᴀᴅᴅɪᴛɪᴏɴᴀʟ ɢʀᴏᴜᴘs🔥"
    elif 80 <= umm < 85:
        bar = "🌟ᴛᴀᴘ ᴛᴏ ᴇxᴘʟᴏʀᴇ ᴍᴏʀᴇ ᴄʜᴀᴛ ᴏᴘᴛɪᴏɴs🌟"
    elif 85 <= umm < 90:
        bar = "🐥ᴄʟɪᴄᴋ ғᴏʀ ɪᴏɪɴɪɴɢ ɴᴇᴡ ᴄʜᴀᴛ ʀᴏᴏᴍs🐥"
    elif 90 <= umm < 95:
        bar = "❣️ᴛᴀᴘ ᴛᴏ ɪᴏɪɴ ᴅɪғғᴇʀᴇɴᴛ ɢʀᴏᴜᴘ ᴄʜᴀᴛs❣️"
    elif 95 <= umm < 100:
        bar = "⚡ᴄʟɪᴄᴋ ғᴏʀ ɢᴇᴛᴛɪɴɢ ᴀᴅᴅᴇᴅ ɪɴ ᴄʜᴀᴛs◉⚡"
    else:
        bar = "✨ᴛᴀᴘ ʜᴇʀᴇ ғᴏʀ ɢʀᴏᴜᴘ ᴄʜᴀᴛ ɪɴᴠɪᴛᴇs✨"
    buttons = [
        [
