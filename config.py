...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "--1002146858611"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/moonsupportgroup")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/moonsupportgroup")
